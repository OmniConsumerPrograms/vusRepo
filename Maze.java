...
public class Maze implements Cloneable { 
  ...
  protected Stack<Command> moves = new Stack<Command>(); 

  protected Component view; 

  private static final int ROOM_SIZE = 100; 
  private static final int WALL_THICKNESS = 6;
  private static final int MARGIN = 30; // margin from the window frame
...
public static class MazePanel extends JPanel { 
	...
	public MazePanel(Maze maze) { 
	  ...
	  if (maze != null) { 
		maze.setView(this); 
		Dimension d = maze.getDimension(); //inside getDimension is calculate dimension
		if (d != null) 
		{ 
